...
AEOLUS_DEFINITION_FILE=AEOLUS-20191015.codadef
AEOLUS_DEFINITION_URL=https://github.com/stcorp/codadef-aeolus/releases/download/20191015/${AEOLUS_DEFINITION_FILE}

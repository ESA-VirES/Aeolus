...
AEOLUS_DEFINITION_FILE=AEOLUS-20210310.codadef
AEOLUS_DEFINITION_URL=https://github.com/stcorp/codadef-aeolus/releases/download/20210310/${AEOLUS_DEFINITION_FILE}
